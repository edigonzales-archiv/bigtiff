...
```
gdal_translate orthofoto_2016_rgb_12_5cm.vrt ../singletiff/2016/orthofoto_2016_rgb_12_5cm_deflate.tif -co TILED=YES -co COMPRESS=DEFLATE -co PREDICTOR=1 -co BIGTIFF=YES
